...
```{r}
Box.test(varma1_0$residuals[,1], lag = 20)
Box.test(varma1_0$residuals[,2], lag = 20)
Box.test(varma1_0$residuals[,3], lag = 20)
Box.test(varma1_0$residuals[,4], lag = 20)
Box.test(varma1_0$residuals[,5], lag = 20)
Box.test(varma1_0$residuals[,6], lag = 20)
Box.test(varma1_0$residuals[,7], lag = 20)
```
...
comparetable <- tibble(
  ...
  AIC = c(
    ...
    arima111$aic,
    arima015$aic,
    mlm.ts2.arima300$aic,
    mlm.ts2.arima300$aic,
    dlm.ts6.arima201$aic,
    dlm.ts6.arima201$aic,
    arima111.garch11@fit$ics['AIC']*length(df.ts.modelset.train$IIPI),
    arima111.garch11@fit$ics['AIC']*length(df.ts.modelset.train$IIPI),
    varma1_0$aic*length(df.ts.modelset.train$IIPI),
    arima210.garch11@fit$ics['AIC']*length(df.ts.modelset.train$IIPI),
    arima210.garch11@fit$ics['AIC']*length(df.ts.modelset.train$IIPI),
