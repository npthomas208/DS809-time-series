...
pred.arima210nahead <- pred.arima %>% append(predict(arima210, n.ahead = 10)$pred)
...
pred.arima111nahead <- pred.arima %>% append(predict(arima111, n.ahead = 10)$pred)
